...
if (isset($argc) && $argc == 2) {
    ...
    switch ($argv[1]) {
        case 'empleados':
            $ventas = Ventas::consultaFiltradaRelacionada("empleados", "paco");
            print_r($ventas);
            break;
        case 'clientes':
            $ventas = Ventas::consultaFiltradaRelacionada("clientes", "a");
            print_r($ventas);
            break;
        case "id":
            #$ventas = Ventas::consultaFiltrada("id", 5);
            Ventas::consultaFiltrada("id", 5);
            #print_r($ventas);
            break;
    }
}
